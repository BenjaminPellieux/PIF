...
struct LFErecMsg_
{
  ...
  _fields_number_type fields_number;
   ...
   typedef std::vector< ::sick_scan::LFErecFieldMsg_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::sick_scan::LFErecFieldMsg_<ContainerAllocator> >> _fields_type;
  _fields_type fields;
