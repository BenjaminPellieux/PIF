...
struct RadarPreHeader_
{
  ...
  _radarPreHeaderMeasurementParam1Block_type radarPreHeaderMeasurementParam1Block;
   ...
   typedef std::vector< ::sick_scan::RadarPreHeaderEncoderBlock_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::sick_scan::RadarPreHeaderEncoderBlock_<ContainerAllocator> >> _radarPreHeaderArrayEncoderBlock_type;
